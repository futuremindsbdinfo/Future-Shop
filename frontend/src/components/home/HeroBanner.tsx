...
export function HeroBanner() {
  return (
    <section className="w-full bg-gradient-to-br from-[#1a6bdf] to-[#1559bd] text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 text-center sm:py-16 md:py-24">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm text-blue-100 sm:mt-4 sm:text-base md:text-lg" lang="bn">
          স্থানীয় বিক্রেতাদের পণ্য, দ্রুত ডেলিভারি
        </p>
        <Button
          size="lg"
          nativeButton={false}
          className="mt-6 h-11 bg-white px-6 text-[#1a6bdf] hover:bg-blue-50 sm:mt-8"
