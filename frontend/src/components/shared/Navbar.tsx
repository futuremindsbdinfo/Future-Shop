      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4">
        ...
        <Sheet>
          ...
          <SheetContent side="left" className="w-72">
            <SheetHeader>
              <SheetTitle className="text-left text-[#1a6bdf]">LocalBazaar</SheetTitle>
            </SheetHeader>
            <nav className="mt-4 flex flex-col gap-1 overflow-y-auto px-2 pb-6">
              <Link href="/" className="rounded px-2 py-2 text-sm hover:bg-muted">Home</Link>
              <Link href="/categories" className="rounded px-2 py-2 text-sm hover:bg-muted">Categories</Link>
        ...
        {user ? (
          ...
          <div className="hidden shrink-0 items-center gap-2 sm:flex">
            ...
            <Button className="bg-[#1a6bdf] hover:bg-[#1559bd]" render={<Link href="/register" />}>
              Register
            </Button>
          </div>
        )}
